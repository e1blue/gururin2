...
static void setParts(struct hknwCharaParts **ptrParts, int u, int v, bool isActive){
	...
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_HEAD, -0.05,  0.10,  0.10, u +  0, v +  96, 16, 0x00, isActive);
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_HEAD, -0.05, -0.10,  0.10, u +  0, v +  96, 16, 0x10, isActive);
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_HEAD,  0.12,  0.00, -0.04, u +  0, v + 112, 16, 0x00, isActive);
...
static void setPosesStand(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_STAND, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.03,  0.00,  0.45, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesWalk(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.09,  0.00,  0.38, CONST_PI * 0.0, 0x00, isActive);
	...
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 1, HKNWCHARAPARTSID_HUMAN_HEAD,  0.09,  0.00,  0.40, CONST_PI * 0.0, 0x00, isActive);
	...
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 2, HKNWCHARAPARTSID_HUMAN_HEAD,  0.09,  0.00,  0.38, CONST_PI * 0.0, 0x00, isActive);
	...
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 3, HKNWCHARAPARTSID_HUMAN_HEAD,  0.09,  0.00,  0.40, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesSquat(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_SQUAT, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.15,  0.00,  0.36, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesJump(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_JUMP, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.03,  0.00,  0.38, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesFall(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_FALL, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.03,  0.00,  0.38, CONST_PI * 0.0, 0x00, isActive);
	...
	for(int i = 0; i < 20; i++){
		...
		switch(i){
			case 0: case 2: case 4: case 6:
				hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_HAPPY, i, HKNWCHARAPARTSID_HUMAN_HEAD,  0.03,  0.00, 0.45 + jump, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesBreak1(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_BREAK1, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.08,  0.00,  0.41, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesBreak2(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_BREAK2, 0, HKNWCHARAPARTSID_HUMAN_HEAD,  0.03,  0.00,  0.33, CONST_PI * 0.0, 0x00, isActive);
