...
static void setParts(struct hknwCharaParts **ptrParts, int u, int v, bool isActive){
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_BODY,  0.00,  0.00,  0.00, u +  0, v +  0, 32, 0x00, isActive);
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_BODY,  0.18,  0.00,  0.04, u +  0, v + 32, 16, 0x00, isActive);
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_BODY,  0.00,  0.13,  0.23, u +  0, v + 48, 16, 0x00, isActive);
	hknwCharaPartsSet((*ptrParts)++, HKNWCHARAPARTSID_HUMAN_BODY,  0.00, -0.13,  0.23, u +  0, v + 48, 16, 0x10, isActive);
...
static void setPosesStand(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_STAND, 0, HKNWCHARAPARTSID_HUMAN_BODY, -0.02,  0.00,  0.34, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesWalk(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 0, HKNWCHARAPARTSID_HUMAN_BODY,  0.00,  0.00,  0.30, CONST_PI * 0.0, 0x00, isActive);
	...
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 1, HKNWCHARAPARTSID_HUMAN_BODY,  0.00,  0.00,  0.33, CONST_PI * 0.0, 0x00, isActive);
	...
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 2, HKNWCHARAPARTSID_HUMAN_BODY,  0.00,  0.00,  0.30, CONST_PI * 0.0, 0x00, isActive);
	...
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_WALK, 3, HKNWCHARAPARTSID_HUMAN_BODY,  0.00,  0.00,  0.33, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesSquat(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_SQUAT, 0, HKNWCHARAPARTSID_HUMAN_BODY,  0.04,  0.00,  0.25, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesJump(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_JUMP, 0, HKNWCHARAPARTSID_HUMAN_BODY, -0.02,  0.00,  0.27, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesFall(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_FALL, 0, HKNWCHARAPARTSID_HUMAN_BODY, -0.02,  0.00,  0.27, CONST_PI * 0.0, 0x00, isActive);
	...
	for(int i = 0; i < 20; i++){
		...
		switch(i){
			case 0: case 2: case 4: case 6:
				hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_HAPPY, i, HKNWCHARAPARTSID_HUMAN_BODY, -0.02,  0.00, 0.34 + jump, CONST_PI * 0.0, 0x00, isActive);
			...
			case 1: case 3: case 5: case 7: case 8: case 9:
				hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_HAPPY, i, HKNWCHARAPARTSID_HUMAN_BODY, -0.02, -0.02, 0.34 + jump, CONST_PI * 0.0, 0x00, isActive);
				hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_HAPPY, i, HKNWCHARAPARTSID_HUMAN_FTR1, -0.02, -0.03, 0.10 + jump, CONST_PI * 0.0, 0x00, isActive);
				hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_HAPPY, i, HKNWCHARAPARTSID_HUMAN_FTL2, -0.12,  0.12, 0.20 + jump, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesBreak1(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_BREAK1, 0, HKNWCHARAPARTSID_HUMAN_BODY,  0.03,  0.00,  0.30, CONST_PI * 0.0, 0x00, isActive);
...
static void setPosesBreak2(struct hknwCharaPoses **ptrPoses, bool isActive){
	hknwCharaPosesSet((*ptrPoses)++, HKNWCHARAPOSESID_BREAK2, 0, HKNWCHARAPARTSID_HUMAN_BODY, -0.02,  0.00,  0.22, CONST_PI * 0.0, 0x00, isActive);
